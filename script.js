...
function autoStartLanguages() {
    ...
    const languages = [
        ...
        { lang: "Chinese", text: "谢谢 辛迪" },
        { lang: "Arabic", text: "شكراً سيندي" },
        ...
        { lang: "Bengali", text: "ধন্যবাদ সিন্ডি" },
        { lang: "Punjabi", text: "ਧੰਨਵਾਦ ਸਿੰਡੀ" },
        { lang: "Tamil", text: "நன்றி சிண்டி" },
        { lang: "Urdu", text: "شکریہ سنڈی" }
    ];
