...
function autoStartLanguages() {
    ...
    const languages = [
        ...
        { lang: "Japanese", text: "Arigato Cindy" },
        { lang: "Korean", text: "Gamsahamnida Cindy" },
        { lang: "Chinese", text: "Xie xie Cindy" },
        { lang: "Arabic", text: "Shukran Cindy" },
        { lang: "Russian", text: "Spasibo Cindy" },
        { lang: "Hindi", text: "Dhanyavad Cindy" },
        { lang: "Dutch", text: "Dank je Cindy" },
        { lang: "Swedish", text: "Tack Cindy" },
        { lang: "Norwegian", text: "Takk Cindy" },
        { lang: "Danish", text: "Tak Cindy" },
        { lang: "Finnish", text: "Kiitos Cindy" },
        { lang: "Polish", text: "Dziękuję Cindy" },
        { lang: "Czech", text: "Děkuji Cindy" },
        { lang: "Hungarian", text: "Köszönöm Cindy" },
        { lang: "Romanian", text: "Mulțumesc Cindy" },
        { lang: "Greek", text: "Efharisto Cindy" },
        { lang: "Turkish", text: "Tesekkurler Cindy" },
        { lang: "Hebrew", text: "Toda Cindy" },
        { lang: "Thai", text: "Khop khun Cindy" },
        { lang: "Vietnamese", text: "Cảm ơn Cindy" },
        { lang: "Indonesian", text: "Terima kasih Cindy" },
        { lang: "Malay", text: "Terima kasih Cindy" },
        { lang: "Filipino", text: "Salamat Cindy" },
        { lang: "Swahili", text: "Asante Cindy" },
        { lang: "Zulu", text: "Ngiyabonga Cindy" },
        { lang: "Welsh", text: "Diolch Cindy" },
        { lang: "Irish", text: "Go raibh maith agat Cindy" },
        { lang: "Catalan", text: "Gràcies Cindy" },
        { lang: "Basque", text: "Eskerrik asko Cindy" },
        { lang: "Ukrainian", text: "Dyakuyu Cindy" },
        { lang: "Bulgarian", text: "Blagodarya Cindy" },
        { lang: "Croatian", text: "Hvala Cindy" },
        { lang: "Serbian", text: "Hvala Cindy" },
        { lang: "Slovak", text: "Ďakujem Cindy" },
        { lang: "Slovenian", text: "Hvala Cindy" },
        { lang: "Estonian", text: "Tänan Cindy" },
        { lang: "Latvian", text: "Paldies Cindy" },
        { lang: "Lithuanian", text: "Ačiū Cindy" },
        { lang: "Maltese", text: "Grazzi Cindy" },
        { lang: "Icelandic", text: "Takk Cindy" },
        { lang: "Bengali", text: "Dhonyobad Cindy" },
        { lang: "Punjabi", text: "Dhannavad Cindy" },
        { lang: "Tamil", text: "Nandri Cindy" },
        { lang: "Urdu", text: "Shukriya Cindy" }
    ];
