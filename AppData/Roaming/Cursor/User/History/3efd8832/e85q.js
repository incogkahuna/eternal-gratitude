...
function initFeedPage() {
    ...
    const gratitudePhrases = [
        ...
        // Additional heartfelt variations
        'Cindy, your kindness radiates.',
        'Thank you, Cindy. You shine bright.',
        'Cindy, you make everything better.',
        'Thank you, Cindy. You\'re pure magic.',
        'Cindy, you\'re absolutely wonderful.',
        'Thank you, Cindy. You\'re a blessing.',
        'Cindy, you\'re incredibly special.',
        'Thank you, Cindy. You\'re amazing.',
        'Cindy, you\'re truly appreciated.',
        'Thank you, Cindy. You\'re valued.',
        'Cindy, you\'re deeply loved.',
        'Thank you, Cindy. You\'re cherished.',
        'Cindy, you\'re irreplaceable.',
        'Thank you, Cindy. You\'re treasured.',
        'Cindy, you\'re absolutely perfect.',
        'Thank you, Cindy. You\'re everything.'
    ];
    ...
    function generateGratitudeBatch(count) {
        for (let i = 0; i < count; i++) {
            ...
            // Random font variation (1-12)
            const fontClass = `font-${Math.floor(Math.random() * 12) + 1}`;
            ...
            if (Math.random() < 0.15) {
                line.style.textShadow = '0 0 15px currentColor';
            }
            if (Math.random() < 0.1) {
...
function initLanguagesPage() {
    ...
    function showNextLanguage() {
        ...
        // Next language after delay (2x faster)
        setTimeout(showNextLanguage, 2000);
    }
...
function handleTouchMove(e) {
    ...
    // Check for vertical scroll navigation
