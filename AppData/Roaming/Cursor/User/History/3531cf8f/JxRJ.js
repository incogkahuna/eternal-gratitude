...
form.addEventListener('submit', async (e) => {
  ...
  // Try to use real API endpoint if available, otherwise use mock
  let response;
  try {
    const apiResponse = await fetch('/api/storeThanks', {
      method: 'POST',
      headers: {
    ...
    console.log('Using mock API response (real endpoint not available)');
